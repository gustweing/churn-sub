...
tb_share AS (
    ...
    SELECT 
        ...
        SUM(CASE WHEN NameProduct = 'Lista de presenca' THEN QuantityProduct ELSE 0 END) AS qtdeListaPresenca,
        ...
        SUM(CASE WHEN NameProduct = 'Presenca Streak' THEN QuantityProduct ELSE 0 END) AS qtdePresencaStreak,
        ...
        SUM(CASE WHEN NameProduct = 'Lista de presenca' THEN pointsTransaction ELSE 0 END) AS pointsListaPresenca,
        ...
        SUM(CASE WHEN NameProduct = 'Presenca Streak' THEN pointsTransaction ELSE 0 END) AS pointsPresencaStreak,
        ...
        1.0 * SUM(CASE WHEN NameProduct = 'Lista de presenca' THEN QuantityProduct ELSE 0 END) / SUM(QuantityProduct) AS pctListaPresenca,
        ...
        1.0 * SUM(CASE WHEN NameProduct = 'Presenca Streak' THEN QuantityProduct ELSE 0 END) / SUM(QuantityProduct) AS pctPresencaStreak,
